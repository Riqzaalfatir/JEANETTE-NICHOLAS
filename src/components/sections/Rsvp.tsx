    ...
    <>
      ...
      <div className="relative w-full overflow-hidden lg:hidden">
        ...
        <div className="relative z-20 bg-[#FEFFF9] mx-[25px] mt-[48px] shadow-md text-center pb-[40%]">
          <h2 data-aos="fade-in" className="font-david pt-[67px] font-bold text-[24px] text-[#CD4964]">RSVP</h2>
          <p data-aos="fade-up" data-aos-delay="100" className="mt-[35px] font-cormorant text-[13px] text-[#CD4964]">Dear Mr./Mrs./Ms.</p>
          <p data-aos="fade-up" data-aos-delay="300" className="mt-[25px] font-cormorant text-[13px] font-bold text-[#CD4964]">.............</p>
          ...
          <p data-aos="fade-in" data-aos-delay="1100" className="mt-[43px] font-cormorant text-[13px] text-[#CD4964]">ARE YOU SURE?</p>
          <button data-aos="fade-up" data-aos-delay="1100" className="mt-[43px] font-cormorant text-[13px] bg-[#F9732A] text-[#FEFBF0] font-semibold w-[200px] h-[30px] rounded-full">CONFIRM NOT ATTEND</button>
          <p data-aos="fade-up" data-aos-delay="1500" className="mt-[43px] font-cormorant text-[13px] text-[#CD4964]">Having trouble with RSVP?</p>
          <button data-aos="fade-up" data-aos-delay="1500" onClick={waHelpdesk} className="mt-[22px] mx-auto font-cormorant text-[13px] bg-[#F9732A] text-[#FEFBF0] font-semibold w-[200px] h-[30px] rounded-full flex items-center justify-center gap-1">
            <Image src="/images/rsvp/lonceng.svg" alt="wa" width={18} height={23} className="w-[20px] object-contain" />
            CHAT HELPDESK TEAM
          </button>
        </div>
      </div>
      ...
      >
        ...
        <Image data-aos="fade-in"
          ...
          height={160}
          className="absolute z-30 h-auto"
          style={{ bottom: "-1vw", left: "13vw", width: "39vw" }}
        />

        {/* Card putih */}
        <div
          className="absolute left-1/2 -translate-x-1/2 bg-[#FEFFF9] shadow-md text-center z-20"
          style={{
            width: "38.23vw",
            height: "71.56vw",
            top: "3.24vw",
        ...
        >
          <h2 data-aos="fade-in" className="font-david font-bold text-[#CD4964]"
            style={{ paddingTop: "10vw", fontSize: "3.17vw" }}
          >RSVP</h2>

          <p data-aos="fade-up" data-aos-delay="100" className="font-cormorant text-[#CD4964]"
            style={{ marginTop: "2.32vw", fontSize: "1.32vw" }}
          >Dear Mr./Mrs./Ms.</p>

          <p data-aos="fade-up" data-aos-delay="300" className="font-cormorant font-bold text-[#CD4964]"
            style={{ marginTop: "1.65vw", fontSize: "1.32vw" }}
          >.............</p>

          <p data-aos="fade-up" data-aos-delay="500" className="font-cormorant text-[#CD4964]"
            style={{ marginTop: "2.25vw", fontSize: "1.32vw", lineHeight: "1.85vw" }}
          >
            Kindly confirm your attendance before <br />
            <span className="font-bold">02 May 2026</span>
          </p>

          <div className="flex justify-center" style={{ gap: "0.66vw", marginTop: "3.05vw" }}>
            <button data-aos="fade-right" data-aos-delay="700"
              onClick={() => { setStatus("attend"); setOpenPopup(true); }}
          ...
          <p data-aos="fade-in" data-aos-delay="1100" className="font-cormorant text-[#CD4964]"
            style={{ marginTop: "3.84vw", fontSize: "1.32vw" }}
          >ARE YOU SURE?</p>

          <button data-aos="fade-up" data-aos-delay="1100"
          ...
          >CONFIRM NOT ATTEND</button>

          <p data-aos="fade-up" data-aos-delay="1500" className="font-cormorant text-[#CD4964]"
            style={{ marginTop: "2.84vw", fontSize: "1.32vw" }}
          >Having trouble with RSVP?</p>

          <button data-aos="fade-up" data-aos-delay="1500" onClick={waHelpdesk}
            className="mx-auto font-cormorant bg-[#F9732A] text-[#FEFBF0] font-semibold rounded-full flex items-center justify-center"
            style={{ marginTop: "1.46vw", fontSize: "1.32vw", width: "21.83vw", height: "2.65vw", gap: "0.4vw" }}
          >
            <Image src="/images/rsvp/lonceng.svg" alt="wa" width={18} height={23} style={{ width: "1.7vw", height: "auto" }} />
            CHAT HELPDESK TEAM
          </button>
        </div>
      </div>
